...
- [ ] 08〜20 に残る個別の未確認項目の裏取り（優先度低）。第1弾（終了保護、ODCR、S3 最小期間・Intelligent-Tiering、GuardDuty EC2、ACM エクスポート、Lambda@Edge リージョン、OAC と S3 ウェブサイト、WAF geo）は 2026-09-26 完了。第2弾: Aurora Global 昇格（原文は「通常数分」で、ノート 08/09 を訂正、2026-09-26）。第3弾: CloudTrail ネットワークアクティビティイベント（2026-09-26、ノート 13 に反映）。第4弾: Kinesis のモード切り替え制約・Advantage 条件（2026-09-26、ノート 20 に反映。具体的な単価は未確認）。第5弾: SQS の In-flight 上限・メッセージサイズ・可視性タイムアウト（2026-09-26、ノート 17 に反映）。第6弾: SQS の DLQ とリドライブ（2026-09-26、ノート 17 の DLQ 期限の記述を FIFO について訂正）。第7弾: SQS の Lambda イベントソースマッピング連携（2026-09-26、ノート 17 に反映。プロビジョンドモードのポーラー上限は原文が食い違い）。第8弾: SQS FIFO ハイスループットの上限数値（2026-09-26、ノート 17 に反映）。第9弾: SQS の暗号化 SSE（2026-09-26、ノート 17 に反映。SSE-SQS の既定有効化・料金は未確認）。第10弾: SQS キューポリシーによるクロスアカウント（2026-09-26、ノート 17 に反映）。第11弾: SSE の既定有効化（新規作成キューで既定有効、2026-09-26、ノート 17 に反映。SSE-SQS 自体の料金は未確認）。第12弾: SQS の SSE の料金（FAQ 原文: SQS 側の追加料金なし、KMS 呼び出しは課金。SSE-SQS 単体の明記は未確認、2026-09-26、ノート 17 に反映）。第13弾: SQS Extended Client Library（256 KB〜2 GB、標準・FIFO 対応、Java 版ページと親ページで対応言語の記述が食い違い、2026-09-26、ノート 17 に反映）。第14弾: SNS / EventBridge の上限比較（SNS 256 KiB・購読数、EventBridge PutEvents は 1 リクエスト 1 MB 未満・ルールあたりターゲット 5、2026-09-26、ノート 17 に反映。AWS サービス由来イベントのサイズ上限は未確認）。第15弾: CloudFront の静的 IP（「CloudFront に静的 IP はない」は誤り。Anycast Static IPs あり、2026-09-26、ノート 16 に反映。料金は未確認）。第16弾: CloudFront Origin Shield（仕組み・13 リージョン・課金対象・オリジングループ / Lambda@Edge との関係、2026-09-26、ノート 16 に反映。単価は未確認）。第17弾: CloudFront 料金クラス（既定・値・課金の挙動、2026-09-26、ノート 16 に反映。リージョン対応表と単価は未確認）。第18弾: CloudFront Invalidation の課金（月 1,000 パス無料・ワイルドカードは 1 パス・タグ無効化も同枠、2026-09-26、ノート 16 に反映。単価は未確認）。第19弾: CloudFront のキャッシュ期間 / TTL（キャッシュポリシーの役割・TTL の計算・no-cache と Minimum TTL・stale-* ディレクティブ、2026-09-26、ノート 16 に反映）。残り: CloudFront のオリジンリクエストポリシー / レスポンスヘッダーポリシー / 管理ポリシー一覧など（`other/fact-check-log.md` 末尾参照）
