...
- `iam.md` などトピック別ファイル: ユーザーが疑問を `Qn ...` と書き、AIが `> **AI回答（日付）**` の引用ブロックで事実確認して回答する
- `qa/mistakes.md` 間違えた理解の記録 / `qa/fact-check-log.md` 事実確認の記録と未確認項目
...
- 訂正したら `qa/fact-check-log.md` に ✅/⚠️/➕ で記録する。未確認の項目は「未確認」と明記する
